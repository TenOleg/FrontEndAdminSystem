import styles from './ChartsOfPosts.module.css';
import {AreaChart, YAxis, ResponsiveContainer, XAxis, Tooltip, CartesianGrid, Area} from "recharts";

const ChartsOfPosts = (props) => {
    return (
        <div className={styles.chart}>
            <h3 className={styles.chartTitle}>Amount of Posts</h3>
                <ResponsiveContainer  width={'100%'} aspect={4 / 1}>
                    <AreaChart width={730} height={250} data={props.postsStatistics}
